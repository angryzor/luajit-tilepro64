...
static const signed long jit_actionlist[1427] = {
  ...
  IEM_X0_Imm16,1880510464,142662464,DASM_STOP,DASM_SECTION,0,DASM_ALIGN,7,DASM_LABEL_G,
  2,1880510464,142720704,1077808566,1074472960,1076923801,1074472960,1880510464,
  142695200,1076940185,1074472960,1880510464,142693152,1076956569,1074472960,
  1880510464,142697248,1076972953,1074472960,1880510464,142701344,1076989337,
  1074472960,1880510464,142699296,13627434,1074472960,13627499,1074472960,536873626,
  1074472960,DASM_IMM,IEM_X0_Imm16,805308058,1074472960,DASM_IMM,IEM_X0_Imm16,
  -266973184,1074492237,13629164,1074472960,536873690,1074472960,DASM_IMM,IEM_X0_Imm16,
  ...
  DASM_IMM,IEM_X0_Imm16,-266973184,1074492237,13629165,1074472960,536873626,
  1074472960,DASM_IMM,IEM_X0_Imm16,805308058,1074472960,DASM_IMM,IEM_X0_Imm16,
  ...
  1077005721,1074472960,1880510464,142611232,536873882,1074472960,DASM_IMM,
  IEM_X0_Imm16,805308058,1074472960,DASM_IMM,IEM_X0_Imm16,-266973184,1074492237,
  1880510464,135398240,1077005721,1074472960,1880510464,1074492193,1086320768,
  1074472960,-266973184,671088641,DASM_L,IEM_X1_Br,12,1082134469,1074472960,
  DASM_IMM,IEM_X0_Imm8,9719940,1074472960,8397124,1074472960,1880510464,1074020482,
  10506372,1074472960,6574212,1074472960,805576,1074472960,536873818,1074472960,
  DASM_IMM,IEM_X0_Imm16,805308058,1074472960,DASM_IMM,IEM_X0_Imm16,-266973184,
  1074492237,13629164,1074472960,DASM_LABEL_L,1,1082134491,1074472960,536871450,
  1074472960,DASM_IMM,IEM_X0_Imm16,805308058,1074472960,DASM_IMM,IEM_X0_Imm16,
  1880510464,142662464,1076888072,1074472960,DASM_IMM,IEM_X0_Imm8,22200832,
  1074472960,-266973184,671088641,DASM_L,IEM_X1_Br,1,DASM_LABEL_L,2,536873626,
  1074472960,DASM_IMM,IEM_X0_Imm16,805308058,1074472960,DASM_IMM,IEM_X0_Imm16,
  ...
  805308058,1074472960,DASM_IMM,IEM_X0_Imm16,1880510464,142662464,1076989337,
  ...
  1074492213,1076923801,1074472960,-266973184,1074492213,1082134464,1074472960,
  DASM_IMM,IEM_X0_Imm8,1077022134,1074472960,-266973184,1074493147,1880510464,
  135661280,DASM_ALIGN,7,DASM_LABEL_G,3,536873882,1074472960,DASM_IMM,IEM_X0_Imm16,
  805308058,1074472960,DASM_IMM,IEM_X0_Imm16,-266973184,1074492237,13629126,
  1074472960,536871322,1074472960,DASM_IMM,IEM_X0_Imm16,805308058,1074472960,
  DASM_IMM,IEM_X0_Imm16,-266973184,1074492237,1085277888,1074472960,DASM_IMM,
  IEM_X0_Imm8,-266973184,671088640,DASM_L,IEM_X1_Br,11,536871322,1074472960,
  DASM_IMM,IEM_X0_Imm16,805308058,1074472960,DASM_IMM,IEM_X0_Imm16,-266973184,
  1074492237,13629125,1074472960,13627739,1074472960,536873882,1074472960,DASM_IMM,
  IEM_X0_Imm16,805308058,1074472960,DASM_IMM,IEM_X0_Imm16,1880510464,142662464,
  1880510464,135790752,DASM_LABEL_L,1,13630299,1074472960,536873626,1074472960,
  ...
  1074472960,6578179,1074472960,24394500,1074472960,13630149,1074472960,22200577,
  ...
  1074472960,DASM_IMM,IEM_X0_Imm8,1076887877,1074472960,DASM_IMM,IEM_X0_Imm8,
  22200577,1074472960,-266973184,671088673,DASM_L,IEM_X1_Br,1,DASM_LABEL_L,
  2,1082134491,1074472960,536871258,1074472960,DASM_IMM,IEM_X0_Imm16,805308058,
  1074472960,DASM_IMM,IEM_X0_Imm16,DASM_STOP,1880510464,142662464,1076887877,
  1074472960,DASM_IMM,IEM_X0_Imm8,22200641,1074472960,-266973184,671088673,
  DASM_L,IEM_X1_Br,2,801516,1074472960,1076923830,1074472960,-266973184,1074493147,
  ...
  0,0,0,0,0,DASM_STOP,13630080,1074472960,13630145,1074472960,1880510464,0,
  DASM_IMM,IEM_X1_J_jal,DASM_STOP,1076890477,1074472960,DASM_IMM,IEM_X0_Imm8,
  ...
  DASM_IMM,IEM_X0_Imm8,DASM_LABEL_L,1,1082134491,1074472960,536871450,1074472960,
  DASM_IMM,IEM_X0_Imm16,805308058,1074472960,DASM_IMM,IEM_X0_Imm16,1880510464,
  142662464,1076888072,1074472960,DASM_IMM,IEM_X0_Imm8,22200832,1074472960,
  -266973184,671088641,DASM_L,IEM_X1_Br,1,1076890348,1074472960,DASM_IMM,IEM_X0_Imm8,
  ...
  IEM_X0_Imm8,DASM_STOP,536873818,1074472960,DASM_IMM,IEM_X0_Imm16,805308058,
  1074472960,DASM_IMM,IEM_X0_Imm16,-266973184,1074492237,13629164,1074472960,
  1076890312,1074472960,DASM_IMM,IEM_X0_Imm8,DASM_LABEL_L,1,1082134491,1074472960,
  ...
  22200832,1074472960,-266973184,671088641,DASM_L,IEM_X1_Br,1,DASM_STOP,1082134491,
  1074472960,536873690,1074472960,DASM_IMM,IEM_X0_Imm16,805308058,1074472960,
...
static int jit_std_prologue(jit_State *J, int stacksize)
{
	...
	//|	addidx CI, CI, 1
	//|	move CI->top, TOP
	dasm_put(Dst, 0, (stacksize)*sizeof(TValue), stacksize, lo16(Dt1(->stack_last)), ha16(Dt1(->stack_last)), lo16(Dt1(->end_ci)), ha16(Dt1(->end_ci)), (1)*sizeof(CallInfo), lo16(Dt4(->top)), ha16(Dt4(->top)));
...
# 163 "ljit_tilepro64.dasc"
	...
	//|.align 64
	//|->GATE_JC:
	dasm_put(Dst, 448, lo16(Dt1(->top)), ha16(Dt1(->top)), lo16(Dt4(->savedpc)), ha16(Dt4(->savedpc)), lo16(Dt1(->savedpc)), ha16(Dt1(->savedpc)), lo16(Dt1(->stack)), ha16(Dt1(->stack)), &luaD_precall, &luaV_execute, lo16(Dt1(->stack)), ha16(Dt1(->stack)), lo16(Dt1(->top)), ha16(Dt1(->top)));
# 183 "ljit_tilepro64.dasc"
...
# 196 "ljit_tilepro64.dasc"
	...
	//|	bz r1, >2
	//|1:
	//|	copyslot TVALUE:r5[0], TVALUE:r4[0]
	//|	addi r4, r4, #TVALUE
	//|	addi r5, r5, #TVALUE
	//|	slt_u r1, r4, TOP
	//|	bnzt r1, <1
	//|2:
	//|	setnilvalue TVALUE:r5[0]		// the new TOP is always set to NIL at this point. i don't care. it don't hurt.
	dasm_put(Dst, 685, lo16(Dt2(->value)), ha16(Dt2(->value)), lo16(Dt1(->ci)), ha16(Dt1(->ci)), -(1)*sizeof(CallInfo), -(1)*sizeof(TValue), sizeof(TValue), lo16(Dt7([0].value)), ha16(Dt7([0].value)), lo16(Dt7([0].value)), ha16(Dt7([0].value)), lo16(Dt7([0].value.na[1])), ha16(Dt7([0].value.na[1])), lo16(Dt7([0].value.na[1])), ha16(Dt7([0].value.na[1])), lo16(Dt7([0].tt)), ha16(Dt7([0].tt)), lo16(Dt7([0].tt)), ha16(Dt7([0].tt)), sizeof(TValue), sizeof(TValue), lo16(Dt7([0].tt)), ha16(Dt7([0].tt)));
# 216 "ljit_tilepro64.dasc"
	//|	addi r5, r5, #TVALUE
	//|	slt_u r1, TVALUE:r5, TOP
	//|	bnzt r1, <2
	//|	add TOP, BASE, r3
	//|	
	...
	//|.align 64
	//|//-----------------------------------------------------------------------
	dasm_put(Dst, 842, sizeof(TValue), lo16(Dt1(->top)), ha16(Dt1(->top)), &luaD_growstack, lo16(Dt1(->top)), ha16(Dt1(->top)), &luaD_growCI);
# 242 "ljit_tilepro64.dasc"
...
# 448 "ljit_tilepro64.dasc"
	...
	//|//	move CINFO:r7, CI
	//|	subidx CI, CI, 1
	dasm_put(Dst, 948, -(1)*sizeof(CallInfo));
...
# 476 "ljit_tilepro64.dasc"
	...
	else
	{
		...
		{
			//|	copyslot BASE[i], BASE[rbase+i]
			dasm_put(Dst, 953, lo16(Dt2([rbase+i].value)), ha16(Dt2([rbase+i].value)), lo16(Dt2([i].value)), ha16(Dt2([i].value)), lo16(Dt2([rbase+i].value.na[1])), ha16(Dt2([rbase+i].value.na[1])), lo16(Dt2([i].value.na[1])), ha16(Dt2([i].value.na[1])), lo16(Dt2([rbase+i].tt)), ha16(Dt2([rbase+i].tt)), lo16(Dt2([i].tt)), ha16(Dt2([i].tt)));
# 483 "ljit_tilepro64.dasc"
		}
		...
		dasm_put(Dst, 1020, (nresults)*sizeof(TValue), lo16(Dt7([0].tt)), ha16(Dt7([0].tt)), sizeof(TValue), (nresults)*sizeof(TValue));
# 491 "ljit_tilepro64.dasc"
	}
...
# 503 "ljit_tilepro64.dasc"
	...
	dasm_put(Dst, 1061, (func)*sizeof(TValue));
# 506 "ljit_tilepro64.dasc"
	if (nargs >= 0) {  /* Previous op was not open and did not set TOP. */
		//|	addidx TOP, BASE, nargs
		dasm_put(Dst, 1066, (nargs)*sizeof(TValue));
# 508 "ljit_tilepro64.dasc"
	}
	//|	move LCL, BASE->value
	//|	movemwi CI->savedpc, J->nextins
# 537 "ljit_tilepro64.dasc"
	//|	jalr LCL->jit_gate		// Call JIT func or GATE_JL/GATE_JC.
	//|	subidx BASE, BASE, func
	dasm_put(Dst, 1071, lo16(Dt2(->value)), ha16(Dt2(->value)), lo16(J->nextins), ha16(J->nextins), lo16(Dt4(->savedpc)), ha16(Dt4(->savedpc)), lo16(Dt5(->jit_gate)), ha16(Dt5(->jit_gate)), -(func)*sizeof(TValue));
...
# 559 "ljit_tilepro64.dasc"
	if (nresults >= 0) {
		...
		//|	slt_u r0, TVALUE:r8, TOP
		//|	bnzt r0, <1
		dasm_put(Dst, 1120, lo16(Dt4(->top)), ha16(Dt4(->top)), (nresults)*sizeof(TValue), lo16(Dt7([0].tt)), ha16(Dt7([0].tt)), sizeof(TValue));
...
static void jit_op_loadk(jit_State *J, int dest, int kidx)
{
	...
	switch (ttype(kk)) {
	case 0:
	dasm_put(Dst, 1162, lo16(Dt2([dest].tt)), ha16(Dt2([dest].tt)));
	  break;
	case 1:
	if (bvalue(kk)) {  /* true */
	dasm_put(Dst, 1175, lo16(Dt2([dest].value)), ha16(Dt2([dest].value)), lo16(Dt2([dest].tt)), ha16(Dt2([dest].tt)));
	} else {  /* false */
	dasm_put(Dst, 1202, lo16(Dt2([dest].value)), ha16(Dt2([dest].value)), lo16(Dt2([dest].tt)), ha16(Dt2([dest].tt)));
	}
	  break;
	case 3: {
	dasm_put(Dst, 1227, lo16(&(kk)->value), ha16(&(kk)->value), lo16(Dt2([dest].value)), ha16(Dt2([dest].value)), lo16(Dt2([dest].value)), ha16(Dt2([dest].value)), lo16(Dt2([dest].tt)), ha16(Dt2([dest].tt)));
	  break;
	}
	case 4:
	dasm_put(Dst, 1280, lo16(gcvalue(kk)), ha16(gcvalue(kk)), lo16(Dt2([dest].value)), ha16(Dt2([dest].value)), lo16(Dt2([dest].tt)), ha16(Dt2([dest].tt)));
	  break;
	default: lua_assert(0); break;
	}
