...
static const signed long jit_actionlist[2621] = {
  ...
  1074472960,-266973184,671088641,DASM_L,IEM_X1_Br,7,DASM_STOP,DASM_SECTION,
  ...
  DASM_IMM,IEM_X0_Imm8,13628012,1074472960,DASM_STOP,1076890312,1074472960,
  ...
  1076890347,1074472960,DASM_IMM,IEM_X0_Imm8,DASM_STOP,536873690,1074472960,
  DASM_IMM,IEM_X0_Imm16,805308058,1074472960,DASM_IMM,IEM_X0_Imm16,1880510464,
  ...
  1880510464,1074492238,13629211,1074472960,536873690,1074472960,DASM_IMM,IEM_X0_Imm16,
  805308058,1074472960,DASM_IMM,IEM_X0_Imm16,1880510464,142662464,DASM_STOP,
  13630080,1074472960,1076890305,1074472960,DASM_IMM,IEM_X0_Imm8,DASM_STOP,
  536874946,1074472960,DASM_IMM,IEM_X0_Imm16,805306498,1074472960,DASM_IMM,
  IEM_X0_Imm16,DASM_STOP,1076890306,1074472960,DASM_IMM,IEM_X0_Imm8,DASM_STOP,
  1076890307,1074472960,DASM_IMM,IEM_X0_Imm8,1880510464,0,DASM_IMM,IEM_X1_J_jal,
  ...
  DASM_IMM,IEM_X0_Imm16,DASM_STOP,1076890307,1074472960,DASM_IMM,IEM_X0_Imm8,
  DASM_STOP,1880510464,0,DASM_IMM,IEM_X1_J_jal,DASM_STOP,536874950,1074472960,
  DASM_IMM,IEM_X0_Imm16,805306758,1074472960,DASM_IMM,IEM_X0_Imm16,536871322,
  1074472960,DASM_IMM,IEM_X0_Imm16,805308058,1074472960,DASM_IMM,IEM_X0_Imm16,
  -266973184,1074492237,13629120,1074472960,536871322,1074472960,DASM_IMM,IEM_X0_Imm16,
  ...
  DASM_PC,IEM_X1_Br,DASM_STOP,13627419,1074472960,536873690,1074472960,DASM_IMM,
  IEM_X0_Imm16,805308058,1074472960,DASM_IMM,IEM_X0_Imm16,1880510464,142662464,
  13627483,1074472960,536873690,1074472960,DASM_IMM,IEM_X0_Imm16,805308058,
  1074472960,DASM_IMM,IEM_X0_Imm16,1880510464,142662464,DASM_STOP,1082146779,
  1074472960,536873690,1074472960,DASM_IMM,IEM_X0_Imm16,805308058,1074472960,
  DASM_IMM,IEM_X0_Imm16,1880510464,142662464,DASM_STOP,536874946,1074472960,
  DASM_IMM,IEM_X0_Imm16,805306498,1074472960,DASM_IMM,IEM_X0_Imm16,DASM_STOP,
  1076890306,1074472960,DASM_IMM,IEM_X0_Imm8,DASM_STOP,536874947,1074472960,
  DASM_IMM,IEM_X0_Imm16,805306563,1074472960,DASM_IMM,IEM_X0_Imm16,DASM_STOP,
  1076890307,1074472960,DASM_IMM,IEM_X0_Imm8,DASM_STOP,536874969,1074472960,
  DASM_IMM,IEM_X0_Imm16,805307993,1074472960,DASM_IMM,IEM_X0_Imm16,13629019,
  1074472960,536873626,1074472960,DASM_IMM,IEM_X0_Imm16,805308058,1074472960,
  DASM_IMM,IEM_X0_Imm16,1880510464,142662464,13630080,1074472960,1076890305,
  1074472960,DASM_IMM,IEM_X0_Imm8,1082134468,1074472960,DASM_IMM,IEM_X0_Imm8,
  1880510464,0,DASM_IMM,IEM_X1_J_jal,DASM_STOP,536873690,1074472960,DASM_IMM,
  IEM_X0_Imm16,805308058,1074472960,DASM_IMM,IEM_X0_Imm16,-266973184,1074492237,
  ...
  1573124,1074472960,1880510464,1074202624,13369604,1074472960,17559808,1074472960,
  1082138587,1074472960,536873690,1074472960,DASM_IMM,IEM_X0_Imm16,805308058,
  ...
  13629120,1074472960,536873690,1074472960,DASM_IMM,IEM_X0_Imm16,805308058,
  1074472960,DASM_IMM,IEM_X0_Imm16,-266973184,1074492237,13629124,1074472960,
  13627393,1074472960,1589313,1074472960,-266973184,1074006048,786497,1074472960,
  -266973184,1074202656,DASM_STOP,-266973184,671088673,DASM_PC,IEM_X1_Br,DASM_STOP,
  -266973184,671088672,DASM_PC,IEM_X1_Br,DASM_STOP,-266973184,671088672,DASM_L,
  IEM_X1_Br,11,DASM_STOP,-266973184,671088673,DASM_L,IEM_X1_Br,11,DASM_STOP,
  536873690,1074472960,DASM_IMM,IEM_X0_Imm16,805308058,1074472960,DASM_IMM,
...
static void dumpstack(TValue* base, TValue* top, CallInfo* ci, lua_State* L, const char* opname)
{
	...
	fprintf(f,"''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''\n");
	fprintf(f," L->base = %08x\n L->top = %08x\n L->ci = %08x\n L->stack = %08x\n L->stack_last = %08x\n\n", base - L->stack, top - L->stack, ci, L->stack, L->stack_last - L->stack);
...
# 175 "ljit_tilepro64.dasc"
	...
	//|	add r8, BASE, r4
	//|
	dasm_put(Dst, 134, lo16(Dt1(->top)), ha16(Dt1(->top)), lo16(Dt2(->value)), ha16(Dt2(->value)), lo16(Dt1(->ci)), ha16(Dt1(->ci)), lo16(Dt1(->nCcalls)), ha16(Dt1(->nCcalls)), lo16(Dt1(->nCcalls)), ha16(Dt1(->nCcalls)), lo16(Dt5(->jit_gate)), ha16(Dt5(->jit_gate)), sizeof(TValue));
# 214 "ljit_tilepro64.dasc"
	...
	dasm_put(Dst, 268, lo16(Dt4(->top)), ha16(Dt4(->top)), lo16(Dt1(->nCcalls)), ha16(Dt1(->nCcalls)), lo16(Dt1(->nCcalls)), ha16(Dt1(->nCcalls)), lo16(Dt4(->base)), ha16(Dt4(->base)), lo16(Dt1(->base)), ha16(Dt1(->base)), lo16(Dt1(->ci)), ha16(Dt1(->ci)), lo16(Dt1(->top)), ha16(Dt1(->top)), lo16(Dt4(->savedpc)), ha16(Dt4(->savedpc)), lo16(Dt1(->savedpc)), ha16(Dt1(->savedpc)), PCRC, lo16(Dt5(->p)), ha16(Dt5(->p)), lo16(Dt10(->jit_status)), ha16(Dt10(->jit_status)));
...
# 281 "ljit_tilepro64.dasc"
	...
	//|	add TOP, BASE, r3
	//|
	dasm_put(Dst, 748, lo16(Dt2(->value)), ha16(Dt2(->value)), lo16(Dt1(->ci)), ha16(Dt1(->ci)), -(1)*sizeof(CallInfo), -(1)*sizeof(TValue), sizeof(TValue), lo16(Dt9([0].value)), ha16(Dt9([0].value)), lo16(Dt9([0].value)), ha16(Dt9([0].value)), lo16(Dt9([0].value.na[1])), ha16(Dt9([0].value.na[1])), lo16(Dt9([0].value.na[1])), ha16(Dt9([0].value.na[1])), lo16(Dt9([0].tt)), ha16(Dt9([0].tt)), lo16(Dt9([0].tt)), ha16(Dt9([0].tt)), sizeof(TValue), sizeof(TValue));
# 302 "ljit_tilepro64.dasc"
	jit_emit_stackdump(J,upthere);
	...
	//|.align 64
	//|//-----------------------------------------------------------------------
	dasm_put(Dst, 897, lo16(Dt1(->top)), ha16(Dt1(->top)), &luaD_growstack, lo16(Dt1(->top)), ha16(Dt1(->top)), &luaD_growCI);
# 324 "ljit_tilepro64.dasc"
...
static void jit_prologue(jit_State *J)
{
	...
	//|	addidx BASE, BASE, 1
	//|	move TOP, r9
	dasm_put(Dst, 1003, (1)*sizeof(TValue));
# 386 "ljit_tilepro64.dasc"

	if(!pt->is_vararg)
	{
		//|	addidx TVALUE:r8, BASE, numparams
		dasm_put(Dst, 1010, (numparams)*sizeof(TValue));
...
# 543 "ljit_tilepro64.dasc"
	...
	//|	subidx CI, CI, 1
	//|	subidx BASE, BASE, 1
	dasm_put(Dst, 1024, -(1)*sizeof(CallInfo), -(1)*sizeof(TValue));
# 549 "ljit_tilepro64.dasc"
	...
	if (nresults < 0) {
		...
		//|2:
		//|	setnilvalue TOP[0]
		dasm_put(Dst, 1033, -(1)*sizeof(TValue), lo16(Dt7([1].value)), ha16(Dt7([1].value)), lo16(Dt7([0].value)), ha16(Dt7([0].value)), lo16(Dt7([1].value.na[1])), ha16(Dt7([1].value.na[1])), lo16(Dt7([0].value.na[1])), ha16(Dt7([0].value.na[1])), lo16(Dt7([1].tt)), ha16(Dt7([1].tt)), lo16(Dt7([0].tt)), ha16(Dt7([0].tt)), (1)*sizeof(TValue), lo16(Dt3([0].tt)), ha16(Dt3([0].tt)));
# 584 "ljit_tilepro64.dasc"
	...
	else
	{
		...
		for(i = 0; i < nresults; i++)
		{
			...
			dasm_put(Dst, 1140, lo16(Dt2([rbase+i+1].value)), ha16(Dt2([rbase+i+1].value)), lo16(Dt2([i].value)), ha16(Dt2([i].value)), lo16(Dt2([rbase+i+1].value.na[1])), ha16(Dt2([rbase+i+1].value.na[1])), lo16(Dt2([i].value.na[1])), ha16(Dt2([i].value.na[1])), lo16(Dt2([rbase+i+1].tt)), ha16(Dt2([rbase+i+1].tt)), lo16(Dt2([i].tt)), ha16(Dt2([i].tt)));
# 591 "ljit_tilepro64.dasc"
		}
		//|	addidx TVALUE:r8, BASE, nresults
		dasm_put(Dst, 1207, (nresults)*sizeof(TValue));
# 593 "ljit_tilepro64.dasc"
		jit_wipe_r8_to_TOP(J);
		//|	addidx TOP, BASE, nresults
		dasm_put(Dst, 1212, (nresults)*sizeof(TValue));
# 595 "ljit_tilepro64.dasc"
	}
...
# 641 "ljit_tilepro64.dasc"
	...
	dasm_put(Dst, 1234, lo16(Dt2(->value)), ha16(Dt2(->value)), lo16(J->nextins), ha16(J->nextins), lo16(Dt4(->savedpc)), ha16(Dt4(->savedpc)), lo16(Dt5(->jit_gate)), ha16(Dt5(->jit_gate)));
# 661 "ljit_tilepro64.dasc"
	if (nresults >= 0) {
		//|	move TOP, CI->top
		dasm_put(Dst, 1279, lo16(Dt4(->top)), ha16(Dt4(->top)));
# 663 "ljit_tilepro64.dasc"
	}
	//|	subidx BASE, BASE, func
	dasm_put(Dst, 1292, -(func)*sizeof(TValue));
...
static void jit_op_move(jit_State *J, int dest, int src)
{
	...
	dasm_put(Dst, 1297, lo16(Dt2([src].value)), ha16(Dt2([src].value)), lo16(Dt2([dest].value)), ha16(Dt2([dest].value)), lo16(Dt2([src].value.na[1])), ha16(Dt2([src].value.na[1])), lo16(Dt2([dest].value.na[1])), ha16(Dt2([dest].value.na[1])), lo16(Dt2([src].tt)), ha16(Dt2([src].tt)), lo16(Dt2([dest].tt)), ha16(Dt2([dest].tt)));
...
static void jit_op_loadk(jit_State *J, int dest, int kidx)
{
	...
	dasm_put(Dst, 1364, lo16(kk), ha16(kk), lo16(Dt9([0].value)), ha16(Dt9([0].value)), lo16(Dt2([dest].value)), ha16(Dt2([dest].value)), lo16(Dt9([0].value.na[1])), ha16(Dt9([0].value.na[1])), lo16(Dt2([dest].value.na[1])), ha16(Dt2([dest].value.na[1])), lo16(Dt9([0].tt)), ha16(Dt9([0].tt)), lo16(Dt2([dest].tt)), ha16(Dt2([dest].tt)));
...
static void jit_op_loadnil(jit_State *J, int first, int last)
{
	...
	{
		//|	setnilvalue BASE[i]
		dasm_put(Dst, 1442, lo16(Dt2([i].tt)), ha16(Dt2([i].tt)));
...
static void jit_op_loadbool(jit_State *J, int dest, int b, int dojump)
{
	...
	if (b) {  /* true */
	dasm_put(Dst, 1455, lo16(Dt2([dest].value)), ha16(Dt2([dest].value)), lo16(Dt2([dest].tt)), ha16(Dt2([dest].tt)));
	} else {  /* false */
	dasm_put(Dst, 1482, lo16(Dt2([dest].value)), ha16(Dt2([dest].value)), lo16(Dt2([dest].tt)), ha16(Dt2([dest].tt)));
	}
# 801 "ljit_tilepro64.dasc"
	if (dojump) {
		//|	j =>J->nextpc+1
		dasm_put(Dst, 1507, J->nextpc+1);
...
# 827 "ljit_tilepro64.dasc"
	...
	//|	jal &luaC_barrierf
	//|5:
	dasm_put(Dst, 1741, lo16(Dt11(->marked)), ha16(Dt11(->marked)), bitmask(BLACKBIT), &luaC_barrierf);
...
static void jit_op_gettable(jit_State *J, int dest, int tab, int rkey)
{
	//|	move r0, L
	//|	addidx r1, BASE, tab
	dasm_put(Dst, 2027, (tab)*sizeof(TValue));
# 1207 "ljit_tilepro64.dasc"
	if(ISK(rkey))
	{
		//|	movewi r2, &J->pt->k[INDEXK(rkey)]
		dasm_put(Dst, 2034, lo16(&J->pt->k[INDEXK(rkey)]), ha16(&J->pt->k[INDEXK(rkey)]));
# 1210 "ljit_tilepro64.dasc"
	}
	else
	{
		//|	addidx r2, BASE, rkey
		dasm_put(Dst, 2043, (rkey)*sizeof(TValue));
# 1214 "ljit_tilepro64.dasc"
	}
	//|	addidx r3, BASE, dest
	//|	jal &luaV_gettable
	dasm_put(Dst, 2048, (dest)*sizeof(TValue), &luaV_gettable);
# 1217 "ljit_tilepro64.dasc"


# 1300 "ljit_tilepro64.dasc"
}
...
static void jit_op_settable(jit_State *J, int tab, int rkey, int rval)
{
	//|	move r0, L
	//|	addidx r1, BASE, tab
	dasm_put(Dst, 2057, (tab)*sizeof(TValue));
# 1306 "ljit_tilepro64.dasc"
	if(ISK(rkey))
	{
		//|	movewi r2, &J->pt->k[INDEXK(rkey)]
		dasm_put(Dst, 2064, lo16(&J->pt->k[INDEXK(rkey)]), ha16(&J->pt->k[INDEXK(rkey)]));
# 1309 "ljit_tilepro64.dasc"
	}
	else
	{
		//|	addidx r2, BASE, rkey
		dasm_put(Dst, 2073, (rkey)*sizeof(TValue));
# 1313 "ljit_tilepro64.dasc"
	}
	if(ISK(rval))
	{
		//|	movewi r3, &J->pt->k[INDEXK(rval)]
		dasm_put(Dst, 2078, lo16(&J->pt->k[INDEXK(rval)]), ha16(&J->pt->k[INDEXK(rval)]));
# 1317 "ljit_tilepro64.dasc"
	}
	else
	{
		//|	addidx r3, BASE, rval
		dasm_put(Dst, 2087, (rval)*sizeof(TValue));
# 1321 "ljit_tilepro64.dasc"
	}
	//|	jal &luaV_settable
	dasm_put(Dst, 2092, &luaV_settable);
# 1418 "ljit_tilepro64.dasc"
}
...
# 1527 "ljit_tilepro64.dasc"
	...
	if(kkb)
	{
		...
		dasm_put(Dst, 2097, lo16(kkb), ha16(kkb), lo16(Dt9([0].value)), ha16(Dt9([0].value)), lo16(Dt9([0].value.na[1])), ha16(Dt9([0].value.na[1])));
# 1533 "ljit_tilepro64.dasc"
	}
	else
	{
		//|	loadnumber r0, r1, BASE[rkb]
		dasm_put(Dst, 2130, lo16(Dt2([rkb].value)), ha16(Dt2([rkb].value)), lo16(Dt2([rkb].value.na[1])), ha16(Dt2([rkb].value.na[1])));
# 1537 "ljit_tilepro64.dasc"
	}
	...
	if(kkc)
	{
		...
		dasm_put(Dst, 2155, lo16(kkc), ha16(kkc), lo16(Dt9([0].value)), ha16(Dt9([0].value)), lo16(Dt9([0].value.na[1])), ha16(Dt9([0].value.na[1])));
# 1543 "ljit_tilepro64.dasc"
	}
	else
	{
		//|	loadnumber r2, r3, BASE[rkc]
		dasm_put(Dst, 2188, lo16(Dt2([rkc].value)), ha16(Dt2([rkc].value)), lo16(Dt2([rkc].value.na[1])), ha16(Dt2([rkc].value.na[1])));
# 1547 "ljit_tilepro64.dasc"
	...
	case TM_ADD:
		//|	jal &__float64_add
		dasm_put(Dst, 2213, &__float64_add);
# 1553 "ljit_tilepro64.dasc"
		break;
	case TM_SUB:
		//|	jal &__float64_sub
		dasm_put(Dst, 2218, &__float64_sub);
# 1556 "ljit_tilepro64.dasc"
		break;
	case TM_MUL:
		//|	jal &__float64_mul
		dasm_put(Dst, 2223, &__float64_mul);
# 1559 "ljit_tilepro64.dasc"
		break;
	case TM_DIV:
		//|	jal &__float64_div
		dasm_put(Dst, 2228, &__float64_div);
# 1562 "ljit_tilepro64.dasc"
		break;
	case TM_MOD:
		//|	jal &__float64_rem
		dasm_put(Dst, 2233, &__float64_rem);
# 1565 "ljit_tilepro64.dasc"
		break;
	case TM_POW:
		//|	jal &pow
		dasm_put(Dst, 2238, &pow);
# 1568 "ljit_tilepro64.dasc"
		break;
	case TM_UNM:
		//|	jal &__float64_neg
		dasm_put(Dst, 2243, &__float64_neg);
# 1571 "ljit_tilepro64.dasc"
		break;
	case TM_LT:
		//|	jal &__float64_lt
		dasm_put(Dst, 2248, &__float64_lt);
# 1574 "ljit_tilepro64.dasc"
		break;
	case TM_LE:
		//|	jal &__float64_le
		dasm_put(Dst, 2253, &__float64_le);
...
fpstore:
	if(ev == TM_LT || ev == TM_LE)
	{
		...
		{
			//|	bnz r0, =>target
			dasm_put(Dst, 2258, target);
# 1586 "ljit_tilepro64.dasc"
		}
		else
		{
			//|	bz r0, =>target
			dasm_put(Dst, 2263, target);
# 1590 "ljit_tilepro64.dasc"
	...
	else
	{
		...
		dasm_put(Dst, 2268, lo16(Dt2([dest].value)), ha16(Dt2([dest].value)), lo16(Dt2([dest].value.na[1])), ha16(Dt2([dest].value.na[1])));
# 1596 "ljit_tilepro64.dasc"
		if (dest != rkb && dest != rkc) {
			//|	settti BASE[dest], LUA_TNUMBER
			dasm_put(Dst, 2293, lo16(Dt2([dest].tt)), ha16(Dt2([dest].tt)));
...
fallback:
	...
	if (kkb) {
		//|	movewi r2, kkb
		dasm_put(Dst, 2306, lo16(kkb), ha16(kkb));
# 1606 "ljit_tilepro64.dasc"
	} else {
		//|	addidx r2, BASE, rkb
		dasm_put(Dst, 2315, (rkb)*sizeof(TValue));
# 1608 "ljit_tilepro64.dasc"
	}
	if (kkc) {
		//|	movewi r3, kkc
		dasm_put(Dst, 2320, lo16(kkc), ha16(kkc));
# 1611 "ljit_tilepro64.dasc"
	} else {
		//|	addidx r3, BASE, rkc
		dasm_put(Dst, 2329, (rkc)*sizeof(TValue));
# 1613 "ljit_tilepro64.dasc"
	}
# 1627 "ljit_tilepro64.dasc"
	//|	movemwi L->savedpc, J->nextins
	//|	move r0, L
	//|	addidx r1, BASE, dest
	//|	movei r4, ev
	//|	jal &luaV_arith
	dasm_put(Dst, 2334, lo16(J->nextins), ha16(J->nextins), lo16(Dt1(->savedpc)), ha16(Dt1(->savedpc)), (dest)*sizeof(TValue), ev, &luaV_arith);
# 1632 "ljit_tilepro64.dasc"
}
...
static void jit_op_not(jit_State *J, int dest, int rb)
{
	...
	dasm_put(Dst, 2369, lo16(Dt2([rb].tt)), ha16(Dt2([rb].tt)), lo16(Dt2([rb].value)), ha16(Dt2([rb].value)), lo16(Dt2([dest].tt)), ha16(Dt2([dest].tt)), lo16(Dt2([dest].value)), ha16(Dt2([dest].value)));
# 1713 "ljit_tilepro64.dasc"
}
...
static void jit_op_test(jit_State *J, int cond, int dest, int src)
{
	...
	//|	add r1, r1, r0
	//|	shri r1, r1, 1
	dasm_put(Dst, 2426, lo16(Dt2([src].tt)), ha16(Dt2([src].tt)), lo16(Dt2([src].value)), ha16(Dt2([src].value)));
# 1906 "ljit_tilepro64.dasc"

	/* Check if we can omit the stack copy. */
	if (dest == src) {  /* Yes, invert branch condition. */
		if (cond) {
			//|	bnz r1, =>target
			dasm_put(Dst, 2461, target);
# 1911 "ljit_tilepro64.dasc"
		} else {
			//|	bz r1, =>target
			dasm_put(Dst, 2466, target);
# 1913 "ljit_tilepro64.dasc"
		}
	} else {  /* No, jump around copy code. */
		if (cond) {
			//|	bz r1, >1
			dasm_put(Dst, 2471);
# 1917 "ljit_tilepro64.dasc"
		} else {
			//|	bnz r1, >1
			dasm_put(Dst, 2477);
# 1919 "ljit_tilepro64.dasc"
		}
		...
		//|	j =>target
		//|1:
		dasm_put(Dst, 2483, lo16(Dt2([src].value.na[1])), ha16(Dt2([src].value.na[1])), lo16(Dt2([dest].tt)), ha16(Dt2([dest].tt)), lo16(Dt2([dest].value)), ha16(Dt2([dest].value)), lo16(Dt2([dest].value.na[1])), ha16(Dt2([dest].value.na[1])), target);
# 1926 "ljit_tilepro64.dasc"
	}
}
...
{
	//|	j =>target
	dasm_put(Dst, 2538, target);
# 1932 "ljit_tilepro64.dasc"
}
...
static void jit_op_close(jit_State *J, int ra)
{
	...
	//|	addidx r1, BASE, ra
    //|	jal &luaF_close
    dasm_put(Dst, 2543, (ra)*sizeof(TValue), &luaF_close);
# 2069 "ljit_tilepro64.dasc"
}
...
static void jit_op_closure(jit_State *J, int dest, int ptidx)
{
	...
	dasm_put(Dst, 2554, nup, lo16(Dt5(->env)), ha16(Dt5(->env)), &luaF_newLclosure, lo16(npt), ha16(npt), lo16(Dt5(->p)), ha16(Dt5(->p)), lo16(Dt2([dest].value)), ha16(Dt2([dest].value)), lo16(Dt2([dest].tt)), ha16(Dt2([dest].tt)));
# 2119 "ljit_tilepro64.dasc"
	/* TODO jit_checkGC(J); */
}
